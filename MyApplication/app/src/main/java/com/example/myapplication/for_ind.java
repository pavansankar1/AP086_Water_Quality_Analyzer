...
public class for_ind extends AppCompatActivity {
    KdGaugeView Ph,Turbidity,Tds,Do,ec,temp;
    TextView decision;
    TextView error,tec,tturb,tph,tdo ;
    int x = 10;
    String GET_URL="https://waterqualitysensor.blob.core.windows.net/sensordata/Industrial_Data.json";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_for_ind);
